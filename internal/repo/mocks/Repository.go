...
func (_m *Repository) GetTaskByID(ctx context.Context, id uint32) (*repo.Task, error) {
...
func (_m *Repository) DeleteTask(ctx context.Context, id uint32) error {
	return nil
}

func (_m *Repository) GetTasks(ctx context.Context) (map[string]repo.Task, error) {
	tasks := make(map[string]repo.Task)
	return tasks, nil
}
